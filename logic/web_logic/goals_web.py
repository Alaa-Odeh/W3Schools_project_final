...
class GoalsWeb():
    ...
    def extract_goal_skills_level(self,goal_name,skills):
        self.goal_name_in_my_goals=WebDriverWait(self._driver,15).until(EC.visibility_of_element_located((By.XPATH, f'//p[contains(text(),"{goal_name}")]')))
